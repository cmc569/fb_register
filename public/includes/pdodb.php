...
/*************Database*************/
//fb_access_token db
class FbAccessToken extends Database {
    protected $dbname  = 'fb_access_token' ;
}
##
...
/*************Database*************/
//accu-qa db
class AccunixV2 extends Database2 {
...
/*******類別定義*****/
class Database2{
    protected $host     = 'accu-qa.mysql.database.azure.com' ;
    protected $user     = 'aqUser@accu-qa' ;
    protected $pass     = 'AccuHit5008!!' ;
    protected $dbname   = '' ;
    protected $port     = '3306' ;
