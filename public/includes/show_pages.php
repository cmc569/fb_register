...
<body>
    <div class="facebook_messenger">
        <h1 class="fb_register"><img src="img/messenger_logo.png">Facebook Messenger Bot 註冊系統</h1>
        <p>★指定要綁定的粉絲專頁</p>
        <form>
...
?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    <select class="form-control" id="bot_app">
                        <option value="accunix" selected>Acunix</option>
                    </select>
                </div>
            </div>
    ...
    <form id="form1" method="POST" action="subscribe.php">
